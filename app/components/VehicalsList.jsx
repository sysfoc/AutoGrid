        ...
        <div className="flex flex-1 flex-col p-3">
          ...
          <div className="mt-auto grid grid-cols-3 gap-1 text-center">
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs line-clamp-1 lg:line-clamp-3 font-semibold text-gray-800 dark:text-white">
                {convertedValues.kms}
              </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs font-semibold line-clamp-1 lg:line-clamp-3 text-gray-800 dark:text-white">
...
const VehicalsList = ({ loadingState }) => {
  ...
  return (
    <section className="my-5 rounded-xl bg-slate-50 py-4 dark:bg-slate-900 sm:mx-8 md:my-10 md:py-10">
      <div className="mb-10">
