        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-2">
            <div className="space-y-6">
              <div className="inline-flex items-center rounded-full bg-app-bg/20 px-3 py-1.5 backdrop-blur-sm border border-app-border/30">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl font-bold leading-tight text-white lg:text-5xl">
                  We Sell Cars{" "}
                  <span className="bg-gradient-to-r from-app-bg to-app-border bg-clip-text text-transparent">
                    Professionally
                  </span>
                </h1>
                ...
                <button
                  ...
                  className="group relative inline-flex transform items-center justify-center overflow-hidden rounded-xl bg-app-bg px-6 py-3 text-base font-semibold text-white shadow-xl transition-all duration-300 hover:bg-app-hover hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-app-bg/50 dark:focus:ring-app-hover/50"
                >
                  <div className="absolute inset-0 bg-app-hover opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
            ...
            <div className="relative">
              <div className="absolute -inset-4 rounded-2xl bg-gradient-to-r from-app-bg/20 to-app-border/10 blur-2xl"></div>
              <div className="relative overflow-hidden rounded-2xl bg-white/10 p-6 backdrop-blur-sm border border-app-border/20">
                <Image
                  src="/Luxury SUV.webp"
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-2 gap-4 sm:grid-cols-4">
              {benefits.map((benefit, index) => (
                <div key={index} className="text-center group">
                  <div className="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-app-bg/20 backdrop-blur-sm border border-app-border/30 text-app-bg transition-all duration-300 group-hover:bg-app-bg group-hover:text-white group-hover:border-app-hover">
                    {benefit.icon}
                  </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {howItWorks.map((step, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl dark:bg-gray-900 border border-gray-200 dark:border-gray-700 hover:border-app-border dark:hover:border-app-border">
                  <div className="absolute left-0 top-0 h-1 w-full bg-gradient-to-r from-app-bg to-app-border"></div>
                  <div className="mb-4 flex items-center justify-between">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-r from-app-bg to-app-border text-white shadow-lg transition-all duration-300 group-hover:from-app-hover group-hover:to-app-bg">
                      {step.icon}
                    </div>
                    <div className="text-5xl font-bold text-gray-100 dark:text-gray-700">
                      {step.step}
                    </div>
                  </div>
                  ...
                  >
                    <div className="rounded-lg bg-app-bg/10 p-3 border border-app-border/20 dark:bg-app-bg/20 dark:border-app-border/30">
                ...
                {index < howItWorks.length - 1 && (
                  <div className="absolute -right-4 top-1/2 z-10 hidden -translate-y-1/2 transform md:block">
                    <ArrowRight className="text-2xl text-app-bg/50" />
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {features.map((feature, index) => (
              <div key={index} className="group text-center">
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-app-bg to-app-border text-white shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl group-hover:from-app-hover group-hover:to-app-bg">
                  {feature.icon}
                </div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:shadow-md hover:border-app-border dark:border-gray-700 dark:bg-gray-800 dark:hover:border-app-border"
              >
                <button
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-5 w-5 text-gray-600 transition-all duration-300 dark:text-gray-400 ${
                      activeIndex === index 
                        ? "rotate-180 text-app-bg dark:text-app-border" 
                        : "rotate-0"
                    }`}
                  />
                </button>
                ...
                >
                  <div className="px-5 pb-5">
                    <div className="mb-3 h-px bg-gradient-to-r from-app-bg to-app-border"></div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-gray-800 to-gray-900 py-16 dark:from-gray-800 dark:to-gray-900">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
            <button
              onClick={handleContactUs}
              className="group flex items-center justify-center rounded-xl border border-transparent bg-gradient-to-r from-app-bg to-app-border px-6 py-3 font-semibold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:from-app-hover hover:to-app-bg hover:shadow-xl"
            >
              Contact Our Experts
            ...
            <Link
              href="/about"
              className="flex items-center justify-center rounded-xl border-2 border-white/30 bg-white/10 px-6 py-3 font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-app-border/50 hover:bg-white/20 dark:border-gray-600/50 dark:bg-gray-700/50 dark:text-gray-100 dark:hover:border-app-border/70 dark:hover:bg-gray-600/60"
            >
              Learn More About Us
            </Link>
          </div>
