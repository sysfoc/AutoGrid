...
const VehicleFinanceCalculator = () => {
  ...
  return (
    <div className="mt-16 min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
      <div className="mx-auto max-w-6xl px-4">
        {/* Header */}
        <div className="mb-8 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 shadow-lg">
          ...
          <div className="rounded-xl bg-white p-6 shadow-lg">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="mt-8 rounded-xl border-2 border-blue-600 bg-white p-6 text-blue-600">
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-3xl bg-blue-600 px-8 py-3 text-sm font-semibold text-white shadow-lg transition-colors duration-200 hover:bg-blue-700"
                  >
                    Get a Rate
                    <SiCashapp />
                  </button>
