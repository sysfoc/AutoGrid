          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:scale-[1.015] hover:shadow-md sm:p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-xl bg-red-100 p-2 sm:p-3">
                <Mail className="h-5 w-5 text-app-button sm:h-6 sm:w-6" />
              </div>
            </div>
          </div>
          ...
          {currentMessages.length === 0 ? (
            <div className="rounded-2xl border border-gray-200 bg-white p-8 text-center shadow-sm sm:p-12">
              <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 sm:h-16 sm:w-16">
                <Mail className="h-6 w-6 text-gray-400 sm:h-8 sm:w-8" />
              </div>
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="mb-4 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-r from-app-button to-app-button-hover sm:h-12 sm:w-12">
        ...
        >
          ...
          <ModalBody>
            ...
            <div className="mb-4 sm:mb-6">
              <label className="mb-2 block text-xs font-medium text-app-text sm:text-sm">
                Your Reply
              </label>
              <textarea
                value={adminReply}
            ...
            {selectedMessage && (
              <>
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4">
                  ...
                  <p className="whitespace-pre-wrap text-xs text-gray-700 sm:text-sm">
                    {selectedMessage.message}
                  </p>
                </div>
