                  ...
                  <TableCell className="py-4 px-6">
                    <div className="flex items-center space-x-3">
                      <Link
                        ...
                        className=" bg-gradient-to-r text-white from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 font-medium px-4 py-2 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg flex items-center space-x-2"
                      >
